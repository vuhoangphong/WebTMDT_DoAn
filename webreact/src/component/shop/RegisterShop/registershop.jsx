        ...
        <div>
            ...
            <form action="">
                <hr/> 
                    ...
                    <input type="text" placeholder="Nhập Tên Shop" name="ts" id="ts" required/>
                    <br/>
                    <label for="tendangnhap"><b>Tên Đăng Nhập</b></label>
                    <input type="text" placeholder="Nhập Tên Đăng Nhập" name="tdn" id="tdn" required/>
                    <br/>
                    ...
                    <input type="text" placeholder="Nhập Địa Chỉ" name="dc" id="dc" required/>
                    <br/>
                    <label for="quan"><b>Quận</b></label>
                    <input type="text" placeholder="Nhập Quận" name="q" id="q" required/>
                    <br/>
                    <label for="phuong"><b>Phường</b></label>
                    <input type="text" placeholder="Nhập Phường" name="p" id="p" required/>
                    <br/>
                    ...
                    <br/>
                <hr/>
                <button type="submit" class="registerbtn" value="register">Đăng Ký</button>
